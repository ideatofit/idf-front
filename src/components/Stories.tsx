...
function Stories(props:{
  ...
  return (
          <div className='bg-[#232631] xl:min-h-[60vh] max-sm:h-[90vh] max-sm:max-h-[40vh] max-sm:min-w-[100vw] max-w-[45vw] min-w-[45vw]  flex items-center justify-center rounded-[1.5rem] border-borderColor border-2'>
